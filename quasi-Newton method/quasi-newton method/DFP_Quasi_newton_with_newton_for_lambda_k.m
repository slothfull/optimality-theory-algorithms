...
% 'zui you bu chang' is derived form 'yi wei sou suo' 'newton method'
% with the limit :'wu yue shu tu gui hua'

function []=DFP_Quasi_newton_with_newton_for_lambda_k(func,x1,x2,H1,epsilon,lambda0,wolfe_powell,n)
%%
...
if wolfe_powell==0
    % detrive lambda_k using 'one-dimension-search'--'newton method'
    syms lambda
...
global k
% get the temporal result if iteration step=2
if k==n
    temporal_result=[x1_new;x2_new];
end
